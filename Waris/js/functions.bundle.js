		...
		TopCart: function() {
			return {
				init: function(selector) {
					...
					const triggerElement = document.getElementById('top-cart-trigger');
		
					triggerElement.addEventListener('mouseover', function() {
						selector[0].classList.add('top-cart-open');
					});
					...
					// Optionally, you can add a hover effect for the cart to remain open when hovering over it
					document.getElementById('top-cart').addEventListener('mouseover', function() {
						selector[0].classList.add('top-cart-open');
					});
		
					document.getElementById('top-cart').addEventListener('mouseout', function() {
						selector[0].classList.remove('top-cart-open');
					});
				}
			};
